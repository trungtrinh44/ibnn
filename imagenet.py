...
def main():
    ...
    parser.add_argument('--det_params', dest="det_params",
                        action=StoreDictKeyPair, keys=('lr', 'weight_decay'), default="{'lr':0.1,'weight_decay':0.0001}")
    parser.add_argument('--sto_params', dest="sto_params",
                        action=StoreDictKeyPair, keys=('lr', 'weight_decay'))
    parser.add_argument('--sgd_params', dest="sgd_params",
    ...
    parser.add_argument('--schedule', dest='lr schedule',
                        action=StoreDictKeyPair, keys=('det', 'sto'), default="{'det': [(1.0, 5), (0.1, 30), (0.01, 60), (0.001, 80)], 'sto': []}")
    parser.add_argument('--warmup', dest='warm up epochs', type=int, default=5)
    parser.add_argument('--posterior', dest="posterior",
                        action=StoreDictKeyPair, keys=('mean_init', 'std_init'))
    parser.add_argument('--args.use_pretrained', action='store_true')
