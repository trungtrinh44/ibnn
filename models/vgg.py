...
__all__ = ["VGG16", "VGG16BN", "VGG19", "VGG19BN",
           "StoVGG16", "StoVGG16BN", "StoVGG19", "StoVGG19BN"]
    ...
    for i, v in enumerate(cfg):
        if v == "M":
            ...
            if i > 0 or stochastic_first_layer:
                sl = StoLayer((in_channels, 1, 1), n_components,
...
class StoVGG(nn.Module):
    def __init__(self, num_classes, n_components, prior_mean, prior_std, depth=16, batch_norm=False, stochastic_first_layer=False):
        ...
        self.features = make_sto_layers(
            cfg[depth], n_components, prior_mean, prior_std, batch_norm, stochastic_first_layer)
    ...
    def forward(self, x, L=1, indices=None):
        ...
        if indices is None:
            indices = torch.multinomial(torch.ones(
                self.n_components, device=x.device), x.size(0), replacement=True)
...
class VGG16(VGG):
    def __init__(self, num_classes):
        super(VGG16, self).__init__(
            num_classes=num_classes, depth=16, batch_norm=False)


class VGG16BN(VGG):
    def __init__(self, num_classes):
        super(VGG16BN, self).__init__(
            num_classes=num_classes, depth=16, batch_norm=True)


class VGG19(VGG):
    def __init__(self, num_classes):
        super(VGG19, self).__init__(
            num_classes=num_classes, depth=19, batch_norm=False)


class VGG19BN(VGG):
    def __init__(self, num_classes):
        super(VGG19BN, self).__init__(
            num_classes=num_classes, depth=19, batch_norm=True)


class StoVGG16(StoVGG):
    def __init__(self, num_classes, n_components, prior_mean, prior_std, stochastic_first_layer):
        super(StoVGG16, self).__init__(num_classes=num_classes, depth=16, batch_norm=False, n_components=n_components,
                                       prior_mean=prior_mean, prior_std=prior_std, stochastic_first_layer=stochastic_first_layer)


class StoVGG16BN(StoVGG):
    def __init__(self, num_classes, n_components, prior_mean, prior_std, stochastic_first_layer):
        super(StoVGG16BN, self).__init__(num_classes=num_classes, depth=16, batch_norm=True, n_components=n_components,
                                         prior_mean=prior_mean, prior_std=prior_std, stochastic_first_layer=stochastic_first_layer)


class StoVGG19(StoVGG):
    def __init__(self, num_classes, n_components, prior_mean, prior_std, stochastic_first_layer):
        super(StoVGG19, self).__init__(num_classes=num_classes, depth=19, batch_norm=False, n_components=n_components,
                                       prior_mean=prior_mean, prior_std=prior_std, stochastic_first_layer=stochastic_first_layer)


class StoVGG19BN(StoVGG):
    def __init__(self, num_classes, n_components, prior_mean, prior_std, stochastic_first_layer):
        super(StoVGG19BN, self).__init__(num_classes=num_classes, depth=19, batch_norm=True, n_components=n_components,
                                         prior_mean=prior_mean, prior_std=prior_std, stochastic_first_layer=stochastic_first_layer)
