python imagenet.py --warmup 0 --batch_size "{'train':1024,'test':1000}" --det_params "{'lr':0.4,'weight_decay':0.0001}" \
                   --gpus 4 --workers 4 --kl_weight "{'kl_min': 1.0, 'kl_max': 1.0, 'last_iter': 8}" \
